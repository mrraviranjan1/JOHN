...
from pyJOHN.functions.misc import google_search
from pyJOHN.functions.tools import async_searcher, dloader, get_ofox
...
SUP_BUTTONS = [
    [
        Button.url("• Repo •", url="https://github.com/mrraviranjan1/JOHN"),
        Button.url("• Support •", url="t.me/johsupportnuserbot"),
    ],
]

ofox = "https://telegra.ph/file/231f0049fcd722824f13b.jpg"
gugirl = "https://telegra.ph/file/0df54ae4541abca96aa11.jpg"
ultpic = "https://telegra.ph/file/ac0a57d2362d0e353baa4.jpg"
...
async def repo(e):
    ...
    await e.answer(res, switch_pm="JOHN Repo.", switch_pm_param="start")
...
async def piston_run(event):
    try:
        ...
        result = await event.builder.article(
            ...
            text=f'**Inline Usage**\n\n`@{asst.me.username} run python print("hello world")`\n\n[Language List](https://telegra.ph/JOHN-09-01-6)',
        )
