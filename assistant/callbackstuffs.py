...
#
# This file is a part of < https://github.com/TeamJOHN/JOHN/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/TeamJOHN/JOHN/blob/main/LICENSE/>.
...
from pyJOHN.functions.gdrive import authorize, create_token_file
from pyJOHN.functions.tools import get_paste, telegraph_client
from pyJOHN.startup.loader import Loader
...
async def update(eve):
    ...
    if heroku_api:
        ...
        execl(sys.executable, sys.executable, "-m", "pyJOHN")
...
async def otvaar(event):
    await event.edit(
        "Other Variables to set for @TheJOHN:",
        buttons=[
            [
...
async def euwhe(event):
    ...
    await event.edit(
        "About [Dual Mode](https://t.me/JOHNUpdates/18)",
        buttons=BT,
        link_preview=False,
    )
